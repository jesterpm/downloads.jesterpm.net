...
class DownloadsControllerTest < ActionController::TestCase
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post :create, download: { description: @download.description, filename: @download.filename, hits: @download.hits, name: @download.name, type: @download.type }
    end
  ...
  test "should update download" do
    patch :update, id: @download, download: { description: @download.description, filename: @download.filename, hits: @download.hits, name: @download.name, type: @download.type }
    assert_redirected_to download_path(assigns(:download))
  end
